...
class telaTkinter:
    ...
    def banco_desconecta(self):
        self.con.close();
        print(f'{RED}Desconected')

    def show_time(self): # RELOGIO
        lib = datetime.now()
        tempo = lib.strftime("%H:%M:%S")
        exibir = Label(text=f'Relogio: {tempo}', bg='#dfe3ee', font=('Century Gothic', 8, 'italic', 'bold',),
                       highlightthickness=1, highlightbackground="#107db2", fg='#107db2')
        exibir.place(x=500, y=270)
        tela.after(1000, self.show_time)
    ...
    def inserir_cx_pego_laranja_zerar(self):
        ...
        try:
            if (posicao_cx == ""):
                messagebox.showwarning(title="ERROR AO INSERIR DADOS",
                                       message="Coloque ID do Funcionario, Antes de Clicar Botao")
            else:
    ...
    def inserir_cx_pego_laranja_sum(self):
        ...
        try:
            if (ncx_pego == "" and posicao_cx == ""):
                messagebox.showwarning(title="ERROR AO INSERIR DADOS",
                                       message="Coloque ID do Funcionario, Coloque Quantidade de Caixa que Pegou Hoje")
            else:
    ...
    def main_win(self):
        ...
        left_Frame = Frame(self.tela, width=198, height=300, bg='#dfe3ee', relief='raised', highlightthickness=3,
                           highlightbackground="#107db2")
        left_Frame.pack(side=LEFT)
        right_Frame = Frame(self.tela, width=400, height=300, bg='#dfe3ee', relief='raised', highlightthickness=2,
                            highlightbackground="#107db2")
        right_Frame.pack(side=RIGHT)
        # ========= Bem Vindo ========
        bemvindo_Label = Label(right_Frame, text='Tela Login', font=('Century Gothic', 30, 'italic', 'bold',),
                               bg='#dfe3ee', highlightthickness=0, highlightbackground="#107db2",
                               fg='#107db2')
        ...
        # ========= Input Usuario =======
        #    ========= Usuario ========
        userLabel_user = Label(right_Frame, text='Usuario/email', font=('Century Gothic', 13, 'bold'), bg='#dfe3ee',
                               highlightthickness=0, highlightbackground="#107db2",
                               fg='#107db2')
        ...
        #    ========= Senha ========
        userLabel_pass = Label(right_Frame, text='Senha', font=('Century Gothic', 15, 'bold'), bg='#dfe3ee',
                               highlightthickness=0, highlightbackground="#107db2", fg='#107db2')
        ...
        # ======== Button ==========
        btn_login = Button(right_Frame, text='Entrar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                           bg='#107db2', command=self.login)
        btn_login.place(x=130, y=200, width=70, height=30)

        btn_senha = Button(right_Frame, text='Cadastrar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                           bg='#107db2', command=self.tela_registro)
    ...
    def tela_registro(self, tela_2=None):
        ...
        # ======== widgets ==========
        left_Frame = Frame(self.tela_2, width=198, height=300, bg='#dfe3ee', relief='raised', highlightthickness=3,
                           highlightbackground="#107db2")
        left_Frame.pack(side=LEFT)
        right_Frame = Frame(self.tela_2, width=400, height=300, bg='#dfe3ee', relief='raised', highlightthickness=2,
                            highlightbackground="#107db2")
        right_Frame.pack(side=RIGHT)
        ...
        # ========= Tela Registro ========
        bemvindo_Label = Label(right_Frame, text='Tela Registro', font=('Century Gothic', 30, 'italic', 'bold',),
                               bg='#dfe3ee', highlightthickness=0, highlightbackground="#107db2",
                               fg='#107db2')
        bemvindo_Label.place(x=100, y=10)
        #  ======== Mensagem Registro Frame 1 Left =========
        msg_registro = Label(left_Frame, font=('Century Gothic', 20), text='Informaçoes:', bg='#dfe3ee',
                             highlightthickness=0, highlightbackground="#107db2", fg='#107db2')
        ...
        self.userLabel_user = Label(right_Frame, text='Usuario/email', font=('Century Gothic', 14, 'bold'),
                                    bg='#dfe3ee', highlightthickness=0, highlightbackground="#107db2", fg='#107db2')
        ...
        #    ========= Senha SENHA ========
        self.userLabel_pass = Label(right_Frame, text='Senha', font=('Century Gothic', 15, 'bold'), bg='#dfe3ee',
                                    highlightthickness=0, highlightbackground="#107db2", fg='#107db2')
        ...
        #    ========= Confirmar Senha ========
        self.userLabel_pass_c = Label(right_Frame, text='Confirmar Senha', font=('Century Gothic', 12, 'bold'),
                                      bg='#dfe3ee', highlightthickness=0, highlightbackground="#107db2", fg='#107db2')
        ...
        self.btn_confirmar = Button(right_Frame, text='Confirmar Registro', font=('Arial', 10, 'italic', 'bold'), bd=3,
                                    fg='white', bg='#107db2', command=self.registrar)
        self.btn_confirmar.place(x=145, y=230, width=130, height=30)

        # ======== Button Voltar =========
        self.btn_voltar = Button(right_Frame, text='Voltar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                                 bg='#107db2', command=self.tela_2.destroy)
    ...
    def tela_menus(self, tela_programa=None):  # TELA QUANDO LOGADO
        ...
        left_Frame_programa = Frame(self.programa, width=198, height=300, bg='#dfe3ee', relief='raised',
                                    highlightthickness=3, highlightbackground="#107db2")
        left_Frame_programa.pack(side=LEFT)
        self.right_Frame_programa = Frame(self.programa, width=400, height=300, bg='#dfe3ee', relief='raised',
                                          highlightthickness=3, highlightbackground="#107db2")
        ...
        msg_programa_bemvindo = Label(self.right_Frame_programa, text=f'Sistema Fluxo Caixa',
                                      font=('Century Gothic', 30), bg='#dfe3ee', fg='#107db2')
        msg_programa_bemvindo.place(x=1, y=1)
        msg_programa_modulo = Label(self.right_Frame_programa, text=f'Modulos de Acesso', font=('Century Gothic', 15),
                                    bg='#dfe3ee', fg='#107db2')
        msg_programa_modulo.place(x=85, y=53, width=200, height=40)
        msg_programa__ = Label(self.right_Frame_programa, text=(f'--' * 100), font=('Century Gothic', 30), bg='#dfe3ee',
                               fg='#107db2')
        msg_programa__.place(x=1, y=80, width=500, height=20)
        msg_programa = Label(left_Frame_programa, text=f'User: ', font=('Century Gothic', 20), bg='#dfe3ee',
                             fg='#107db2')
        msg_programa.place(x=1, y=38)
        msg_programa_usuario = Label(left_Frame_programa, text=f'{self.nome_usuario}', bg='#dfe3ee',
                                     font=('Arial', 10, 'italic', 'bold'), bd=2, fg='GREEN', highlightthickness=2,
                                     highlightbackground="#107db2")
        msg_programa_usuario.place(x=68, y=48)
        msg_programa_usuario = Label(left_Frame_programa, text=f'Status ON', bg='#dfe3ee',
                                     font=('Arial', 15, 'italic', 'bold'), bd=2, fg='GREEN', highlightthickness=2,
        ...
        btn_menu_reg_fun = Button(self.right_Frame_programa, text='Registro Geral',
                                  font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white', bg='#107db2',
                                  command=self.programaFinal)
        btn_menu_reg_fun.place(x=150, y=100)  # , width=500, height=20

        # ======== Button MENUS Cadastrar Funcionario =========
        btn_menu_reg_fun = Button(self.right_Frame_programa, text='Registrar Funcionario',
                                  font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white', bg='#107db2',
                                  command=self.menu_registro_funcionario)
        btn_menu_reg_fun.place(x=125, y=135)  # , width=500, height=20

        # ======== Button MENUS Apagar Registro Funcionario=========
        btn_menu_reg_fun = Button(self.right_Frame_programa, text='Apagar Funcionario',
                                  font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white', bg='#107db2',
                                  command=self.menu_registro_funcioniario_apagar_func)
        btn_menu_reg_fun.place(x=135, y=170)  # , width=500, height=20

        # ======== Button MENUS Valores Caixa =========
        btn_menu_reg_fun = Button(self.right_Frame_programa, text='Valor Produto', font=('Arial', 10, 'italic', 'bold'),
                                  bd=3, fg='white', bg='#107db2',
                                  command=self.menu_valores)
        btn_menu_reg_fun.place(x=150, y=200)  # , width=500, height=20

        btn_menu_reg_fun = Button(self.right_Frame_programa, text='Sair', font=('Arial', 10, 'italic', 'bold'), bd=3,
                                  fg='white', bg='#107db2', command=self.logout_tela_menu)
        btn_menu_reg_fun.place(x=330, y=260)  # , width=500, height=20

        # BTN PARA INSERIR ID E DELETAR APENAS PARA TESTE APENAS USUARIO ADMIN TEM ACESSO
        if self.nome_usuario == 'admin' and self.senha == '123':
            btn_colocar_id_msg = Label(left_Frame_programa, text='CLEAR ID', bg='RED',
                                       font=('Arial', 8, 'italic', 'bold'), bd=3, fg='white')
            btn_colocar_id_msg.place(x=5, y=273, height=19)

            btn_colocar_id_msg1 = Label(left_Frame_programa, text='Apagar ID Usuario Criado', bg='RED',
                                        font=('Arial', 8, 'italic', 'bold'),
                                        bd=3, fg='white')
            btn_colocar_id_msg1.place(x=5, y=250, height=19)
            self.btn_colocar_id_input = Entry(left_Frame_programa, width=5)
            self.btn_colocar_id_input.place(x=65, y=273)
            btn_colocar_id_click = Button(left_Frame_programa, bg='RED', text='Confirmar',
                                          font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                                          command=self.programa.destroy)
            btn_colocar_id_click.place(x=90, y=273, height=21)

    def tela_somar_resultado_funcionario(self):
        self.root.withdraw()
        self.root_delete = Toplevel(self.programa)
        self.root_delete.geometry('700x500+600+153')
        self.root_delete.title("Tela para Pagamento")
        self.root_delete.configure(bg="#003153")

        # =====Frames=====
        # Frame Esquerdo
        self.left_Frame_delete = Frame(self.root_delete, width=100, height=200, bg='#dfe3ee', relief='raised',
                                       highlightthickness=2,
                                       highlightbackground="#0fe3ee")
        self.left_Frame_delete.place(relx=0.02, rely=0.03, relwidth=0.96, relheight=0.45)

        # Frame Direito
        self.right_Frame_delete = Frame(self.root_delete, width=400, height=300, bg='#dfe3ee', relief='raised',
                                        highlightthickness=2,
                                        highlightbackground="#0fe3ee")
        self.right_Frame_delete.place(relx=0.02, rely=0.52, relwidth=0.96, relheight=0.45)

        ############# RESULTADO A PAGAR #############
        resultado_soma_lb = Label(self.left_Frame_delete, text=f'Resultado a Pagar: ',
        ...
        ############ BOTOES DA TELA ##################
        btn_novo_msg = Button(self.left_Frame_delete, text="Limpar Dados da Tela", font=('Arial', 10, 'italic', 'bold'),
                              bd=3, fg='white', bg='#107db2',
                              command=self.limpar_tela_pagamento)
        btn_novo_msg.place(relx=0.025, rely=0.04, relheight=0.09, relwidth=0.22)

        btn_novo_msg = Button(self.left_Frame_delete, text="Mostrar Todos Funcionarios",
                              font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white', bg='#107db2',
                              command=self.buscar_todos_pagamento)
        btn_novo_msg.place(relx=0.35, rely=0.91, relheight=0.09, relwidth=0.3)

        btn_novo_msg = Button(self.root_delete, text="Voltar", font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                              bg='#107db2',
                              command=self.pagamento_voltar_programafinal)
        btn_novo_msg.place(relx=0.9, rely=0.04, relheight=0.05, relwidth=0.074)
        #############################################

        # NUMERO DA POSICAO FUNCIONARIO
        label_cx_hj_lebel = Label(self.root_delete, text="Nº Registro FUNCIONARIO", font=('Arial', 9, 'italic', 'bold'),
                                  fg='#107db2',
        ...
        bt_cx_lebel = Label(self.root_delete, text="QUANTAS CAIXAS TOTAL", font=('Arial', 9, 'italic', 'bold'),
                            fg='#107db2',
                            bg='#dfe3ee',
        ...
        btn_cx_laranja_btn_mais_1 = Button(self.left_Frame_delete, text="SOMAR LARANJA",
                                           font=('Arial', 7, 'italic', 'bold'), bd=3,
                                           fg='white',
                                           bg='#107db2', command=self.Somar_Laranja)
        btn_cx_laranja_btn_mais_1.place(relx=0.05, rely=0.7, relheight=0.08, relwidth=0.15)

        btn_cx_limao_mais_1 = Button(self.left_Frame_delete, text="SOMAR LIMAO", font=('Arial', 7, 'italic', 'bold'),
                                     bd=3,
                                     fg='white',
                                     bg='#107db2', command='self.inserir_cx_pego_limao')
        btn_cx_limao_mais_1.place(relx=0.2, rely=0.7, relheight=0.08, relwidth=0.15)

        btn_cx_tomate_mais_1 = Button(self.left_Frame_delete, text="SOMAR TOMATE", font=('Arial', 7, 'italic', 'bold'),
                                      bd=3,
                                      fg='white',
        ...
        self.tree_pagamento = ttk.Treeview(self.right_Frame_delete,
        ...
        self.tree_pagamento.place(width=668,
                                  height=220)  # (relx=-0.040, rely=-0.015, relheight=1, relwidth=1.2,height=3)
    ...
    def Somar_Laranja(self):
        ...
        try:
            ...
            print(f"{RED} Error Ao Somar: '{error}'")
        ...
        try:
            if quantidade_caixa == "":
                ...
                self.result_valor = Label(self.left_Frame_delete,
                                          text=f'Funcionario {self.result_pesquisa_nome} Recebe: {soma}0 R$',
                                          fg='GREEN', bg='#dfe3ee', anchor=W)
                self.result_valor.place(relx=0.22, rely=0.81, relheight=0.05, relwidth=0.3)
        except Error as err:
    ...
    def limpar_programaFinal(self):
        ...
        self.btn_id_entry_zerar_cx.delete(0, END)
    ...
    def programaFinal(self):
        ...
        btn_novo_msg = Button(left_Frame, text="Limpar Dados da Tela", font=('Arial', 10, 'italic', 'bold'), bd=3,
                              fg='white', bg='#107db2',
                              command=self.limpar_programaFinal)
        btn_novo_msg.place(relx=0.025, rely=0.04, relheight=0.09, relwidth=0.22)

        btn_novo_msg = Button(left_Frame, text="Excluir Funcionario", font=('Arial', 10, 'italic', 'bold'), bd=3,
                              fg='white', bg='#107db2',
                              command=self.deletar_nome_func)
        btn_novo_msg.place(relx=0.25, rely=0.04, relheight=0.09, relwidth=0.2)
        self.btn_novo_msg = Entry(left_Frame)
        self.btn_novo_msg.place(relx=0.46, rely=0.04, relheight=0.09, relwidth=0.2)

        btn_novo_msg = Button(left_Frame, text="Pagamento", font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                              bg='#107db2',
                              command=self.tela_somar_resultado_funcionario)
        btn_novo_msg.place(relx=0.67, rely=0.04, relheight=0.09, relwidth=0.13)

        btn_novo_msg = Button(left_Frame, text="Mostrar Todos Funcionarios", font=('Arial', 10, 'italic', 'bold'), bd=3,
                              fg='white', bg='#107db2',
        ...
        btn_trazer_valores_cx_laranja.place(relx=0.64, rely=0.18, relheight=0.09, relwidth=0.25)
        btn_nfuncionario_btn = Button(left_Frame, text="Filtrar", font=('Arial', 10, 'italic', 'bold'), bd=3,
                                      fg='white',
                                      bg='#107db2', command=self.pesquisar)
        btn_nfuncionario_btn.place(relx=0.562, rely=0.80, relheight=0.09, relwidth=0.20)

        # Funcao Usuario Administrador
        if self.nome_usuario == 'admin' and self.senha == '123':
            truncate_table = Button(left_Frame, text='Limpar Tabela Funcionarios', font=('Arial', 8, 'italic', 'bold'),
                                    bd=3, fg='white',
                                    bg='RED', command=self.truncate_table_admin)
            truncate_table.place(relx=0.70, rely=0.92, relheight=0.09, relwidth=0.3)
        # Nome Funcionario
        bt_nfuncionario_lebel = Label(left_Frame, text="FILTRAR PELO NOME DO FUNCIONARIO",
                                      font=('Arial', 8, 'italic', 'bold'), fg='#107db2', bg='#dfe3ee',
                                      highlightthickness=2, highlightbackground="#759fe6")
        bt_nfuncionario_lebel.place(relx=0.553, rely=0.65, relheight=0.08, relwidth=0.35)
        ...
        # NUMERO CX PEGO HOJE
        bt_cx_lebel = Label(left_Frame, text="PEGOU QUANTAS CAIXAS HOJE", font=('Arial', 8, 'italic', 'bold'),
                            fg='#107db2', bg='#dfe3ee', highlightthickness=2, highlightbackground="#759fe6")
        bt_cx_lebel.place(relx=0.1, rely=0.37, relheight=0.08, relwidth=0.3)
        self.bt_cx_hj_entry = Entry(left_Frame, font=('Arial', 10, 'italic'))
        self.bt_cx_hj_entry.place(relx=0.001, rely=0.37, relheight=0.08, relwidth=0.08)

        # NUMERO DA POSICAO FUNCIONARIO
        label_cx_hj_lebel = Label(left_Frame, text="Nº Registro FUNCIONARIO", font=('Arial', 8, 'italic', 'bold'),
                                  fg='#107db2', bg='#dfe3ee', highlightthickness=2, highlightbackground="#759fe6")
        label_cx_hj_lebel.place(relx=0.1, rely=0.22, relheight=0.08, relwidth=0.23)
        self.btn_posicao_entry = Entry(left_Frame, font=('Arial', 10, 'italic'))
        self.btn_posicao_entry.place(relx=0.001, rely=0.22, relheight=0.08, relwidth=0.08)

        # BOTAO INSERIR + 1 CAIXA PARA FUNCIONARIO = POSICAO DECLARADA
        btn_cx_laranja_btn_mais_1 = Button(left_Frame, text="CX LARANJA", font=('Arial', 7, 'italic', 'bold'), bd=3,
                                           fg='white', bg='#107db2', command=self.inserir_cx_pego_laranja_sum)
        btn_cx_laranja_btn_mais_1.place(relx=0.001, rely=0.5, relheight=0.08, relwidth=0.11)

        btn_cx_limao_mais_1 = Button(left_Frame, text="CX LIMAO", font=('Arial', 7, 'italic', 'bold'), bd=3, fg='white',
                                     bg='#107db2', command=self.inserir_cx_pego_limao_sum)
        btn_cx_limao_mais_1.place(relx=0.11, rely=0.5, relheight=0.08, relwidth=0.11)

        btn_cx_tomate_mais_1 = Button(left_Frame, text="CX TOMATE", font=('Arial', 7, 'italic', 'bold'), bd=3,
                                      fg='white', bg='#107db2', command=self.inserir_cx_pego_tomate_sum)
        btn_cx_tomate_mais_1.place(relx=0.22, rely=0.5, relheight=0.08, relwidth=0.11)

        # BOTAO UPDATE TROCA VALOR DA TABELA SEM CALCULO (USADO MAIS PARA ZERAR)
        bt_cx_lebel = Label(left_Frame, text="INSIRA ID FUNCIONARIO PARA ZERAR", font=('Arial', 8, 'italic', 'bold'),
                            fg='#107db2', bg='#dfe3ee', highlightthickness=2, highlightbackground="#759fe6")
        bt_cx_lebel.place(relx=0.1, rely=0.59, relheight=0.08, relwidth=0.335)
        self.btn_id_entry_zerar_cx = Entry(left_Frame, font=('Arial', 10, 'italic'))
        self.btn_id_entry_zerar_cx.place(relx=0.001, rely=0.59, relheight=0.08, relwidth=0.08)

        btn_cx_laranja_btn_mais_1 = Button(left_Frame, text="ZERAR CX LARANJA", font=('Arial', 7, 'italic', 'bold'),
                                           bd=3, fg='white', bg='#107db2', command=self.inserir_cx_pego_laranja_zerar)
        btn_cx_laranja_btn_mais_1.place(relx=0.001, rely=0.7, relheight=0.08, relwidth=0.155)

        btn_cx_limao_mais_1 = Button(left_Frame, text="ZERAR CX LIMAO", font=('Arial', 7, 'italic', 'bold'), bd=3,
                                     fg='white', bg='#107db2', command=self.inserir_cx_pego_limao_zerar)
        btn_cx_limao_mais_1.place(relx=0.155, rely=0.7, relheight=0.08, relwidth=0.145)

        btn_cx_tomate_mais_1 = Button(left_Frame, text="ZERAR CX TOMATE", font=('Arial', 7, 'italic', 'bold'), bd=3,
                                      fg='white', bg='#107db2', command=self.inserir_cx_pego_tomate_zerar)
        btn_cx_tomate_mais_1.place(relx=0.300, rely=0.7, relheight=0.08, relwidth=0.15)

        # BTN VOLTAR
        btn_novo_msg = Button(left_Frame, text="Voltar", font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                              bg='#107db2', command=self.programa_voltar_menu)
        btn_novo_msg.place(relx=0.9, rely=0.04, relheight=0.09, relwidth=0.10)

        # Tela Exibir Apenas os Valores das Caixas produtos
        self.tv = ttk.Treeview(left_Frame, columns=["col1", "col2", "col3"], show='headings')
        self.tv.place(relx=0.57, rely=0.27, relheight=0.22, relwidth=0.4)
    ...
    def menu_registro_funcionario(self):
        ...
        # Frames
        # Frame Esquerdo
        left_Frame = Frame(self.registro_fun, width=198, height=300, bg='#dfe3ee', relief='raised',
                           highlightthickness=3, highlightbackground="#107db2")
        left_Frame.pack(side=LEFT)
        right_Frame = Frame(self.registro_fun, width=400, height=300, bg='#dfe3ee', relief='raised',
                            highlightthickness=3, highlightbackground="#107db2")
        right_Frame.pack(side=RIGHT)

        msg_dados_fun = Label(right_Frame, text='Insira os Dados \n Funcionario', font=('Century Gothic', 20),
                              bg='#dfe3ee', fg='#107db2')
        msg_dados_fun.place(x=100, y=1)

        #  ======== Mensagem Registro Frame 1 Left =========
        msg_registro_fun_esquerda = Label(left_Frame, font=('Century Gothic', 20, 'italic'),
        ...
        userLabel_user = Label(right_Frame, text='Nome Funcionario', font=('Century Gothic', 9), bg='#dfe3ee',
                               fg='#107db2')
        ...
        userLabel_nascimento = Label(right_Frame, text='Data Nascimento', font=('Century Gothic', 9), bg='#dfe3ee',
                                     fg='#107db2')
        ...
        btn_confirmar_reg = Button(right_Frame, text='Confirmar Registro', font=('Century Gothic', 10), bd=3,
                                   fg='white', bg='#107db2', command=self.registrar_fun_bd)
        btn_confirmar_reg.place(x=145, y=225, width=130, height=30)

        # ======== Button Voltar =========
        btn_voltar = Button(right_Frame, text='Voltar', font=('Century Gothic', 10), bd=3, fg='white', bg='#107db2',
                            command=self.registro_fun.destroy)
    ...
    def menu_registro_funcioniario_apagar_func(self):
        ...
        # Frames
        # Frame Esquerdo
        left_Frame = Frame(self.registro_fun_apagar, width=198, height=300, bg='#dfe3ee', relief='raised',
                           highlightthickness=2, highlightbackground="#107db2")
        left_Frame.pack(side=LEFT)
        right_Frame = Frame(self.registro_fun_apagar, width=400, height=300, bg='#dfe3ee', relief='raised',
                            highlightthickness=2, highlightbackground="#107db2")
        right_Frame.pack(side=RIGHT)

        msg_dados_fun = Label(right_Frame, text='Insira os Dados do \n Funcionario',
                              font=('Century Gothic', 25, 'italic'), bg='#dfe3ee', fg='#107db2')
        msg_dados_fun.place(x=20, y=1)

        #  ======== Mensagem Registro Frame 1 Left =========
        msg_registro_fun_esquerda = Label(left_Frame, font=('Century Gothic', 13),
        ...
        # ========= Input Nome Funcionario ========
        userLabel_user = Label(right_Frame, text='Nome Funcionario', font=('Century Gothic', 12), bg='#dfe3ee',
                               fg='#107db2')
        userLabel_user.place(x=1, y=92)
        # Posicao
        self.user_input_func = Entry(right_Frame, width=30)
        ...
        # Botao Confirmar Registro de Funcionario Banco de Dados
        btn_confirmar_reg = Button(right_Frame, text='Apagar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                                   bg='#107db2', command=self.deletar_nome_func)
        btn_confirmar_reg.place(x=145, y=230, width=130, height=30)

        # ======== Button Voltar =========
        btn_voltar = Button(right_Frame, text='Voltar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                            bg='#107db2', command=self.registro_fun_apagar.destroy)
    ...
    def menu_valores(self):
        ...
        # =====Frames=====
        # Frame Esquerdo
        left_Frame = Frame(self.valores, width=198, height=300, bg='#dfe3ee', relief='raised', highlightthickness=2,
                           highlightbackground="#107db2")
        left_Frame.pack(side=LEFT)
        # Frame Direito
        right_Frame = Frame(self.valores, width=400, height=300, bg='#dfe3ee', relief='raised', highlightthickness=2,
                            highlightbackground="#107db2")
        right_Frame.pack(side=RIGHT)

        msg_dados_fun = Label(right_Frame, text='Insira Valores das Caixa',
                              font=('Century Gothic', 25, 'italic', 'bold'),
                              bg='#dfe3ee', fg='#107db2')
        msg_dados_fun.place(x=1, y=1)

        #  ======== Mensagem Registro Frame 1 Left =========
        msg_registro_fun_esquerda = Label(left_Frame, font=('Century Gothic', 17, 'italic', 'bold'),
                                          text='Registro Valores',
                                          bg='#dfe3ee',
                                          fg='#107db2')
        ...
        # Caixa Laranja
        caixa_laranja = Label(right_Frame, font=('Century Gothic', 10), text='Caixa LARANJA:', bg='#dfe3ee',
                              fg='#107db2')
        ...
        btn_laranja_update = Button(right_Frame, text='Inserir R$', font=('Century Gothic', 10, 'italic'), bd=3,
                                    fg='white', bg='#107db2', command=self.alterar_preco_laranja)
        ...
        btn_limao_update = Button(right_Frame, text='Inserir R$', font=('Century Gothic', 10, 'italic'), bd=3,
                                  fg='white', bg='#107db2', command=self.alterar_preco_limao)
        ...
        btn_tomate_update = Button(right_Frame, text='Inserir R$', font=('Arial', 10, 'italic'), bd=3, fg='white',
                                   bg='#107db2', command=self.alterar_preco_tomate)
        btn_tomate_update.place(x=230, y=150, width=70, height=20)

        # ======== Button Mostrar Valores das Caixa =========
        btn_voltar = Button(right_Frame, text='Valores das Caixas', font=('Arial', 10, 'italic', 'bold'), bd=3,
                            fg='white', bg='#107db2', command=self.exibir_valores_atuais_cx)
        btn_voltar.place(x=165, y=180, width=115, height=30)
        # ======== Button Voltar =========
        btn_voltar = Button(right_Frame, text='Voltar', font=('Arial', 10, 'italic', 'bold'), bd=3, fg='white',
                            bg='#107db2', command=self.valores.destroy)
    ...
    def tela_popup_deletar_id(self):
        ...
        Label(self.root, text=f'ID=: {self.btn_colocar_id_input.get()} , DELETADO COM SUCESSO!', bg='GREEN').place(x=1,
                                                                                                                   y=1)
    ...
    def destroy_tela_registro_func(self):
        if self.registro_fun.quit():
            self.tela_menus()
        else:
            self.tela_menus()

    def destroy_tela_apagar_func(self):
        if self.registro_fun_apagar.quit():
            self.tela_menus()
        else:
            self.tela_menus()
    ...
    def pagamento_voltar_programafinal(self):
        self.root.deiconify()
        self.root_delete.withdraw()

    def programa_voltar_menu(self):
        self.programa.deiconify()
        self.root.withdraw()

    def destroy_programa_final(self):
        self.root.quit()

    def logout_tela_menu(self):
        self.programa.withdraw()
        self.main_win()
...
tela = Tk()
main_screen.main_win()  # Acessa este atributo da caracteristica telaTkinter()
